            ...
            <div class="card-body p-4">
                <form action="{{ route('cliente_recibos.store') }}" method="POST">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="cliente_id" id="cliente_id" class="form-select @error('cliente_id') is-invalid @enderror" required>
                                ...
                                @foreach($clientes as $cliente)
                                    <option value="{{ $cliente->id }}" {{ (old('cliente_id') == $cliente->id || $selected_cliente_id == $cliente->id) ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nro_recibo" id="nro_recibo" class="form-control @error('nro_recibo') is-invalid @enderror" value="{{ old('nro_recibo') }}">
                        @error('nro_recibo')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
