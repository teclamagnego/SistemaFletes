                        ...
                        <div class="row">
                                <div class="col-md-3 mb-3">
                                        ...
                                        <select name="tipo_documento" class="form-select" required>
                                                <option value="DNI" {{ old('tipo_documento', $cliente->tipo_documento)
                                                        == 'DNI' ? 'selected' : '' }}>DNI</option>
                                                <option value="CUIT" {{ old('tipo_documento', $cliente->tipo_documento)
                                                        == 'CUIT' ? 'selected' : '' }}>CUIT</option>
                                                <option value="CUIL" {{ old('tipo_documento', $cliente->tipo_documento)
                                                        == 'CUIL' ? 'selected' : '' }}>CUIL</option>
                                                <option value="Pasaporte" {{ old('tipo_documento', $cliente->
                                                        tipo_documento) == 'Pasaporte' ? 'selected' : '' }}>Pasaporte
                                                </option>
                                        </select>
                                </div>
